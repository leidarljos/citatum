<p align="center">
  <img src="docs/logo/icon.svg" width="120" height="120" alt="leiðarljós: a gold pin">
</p>
...
Ink `#0B0B0A`, cream `#F4F0E6`, gold `#E6A23C`.

- [icon.svg](docs/logo/icon.svg)
- [lockup.svg](docs/logo/lockup.svg)
